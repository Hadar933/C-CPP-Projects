...
int main()
{
	...
	for (int i = 0; i < mediumResults.size(); i++)
	{
	...
	std::cout<<"loaded big files"<<std::endl;
	for (int i = 0; i < bigResults.size(); i++)
	{
		std::cout<<"working on: test no." << i << " "<<" out of" << bigResults.size() <<
		std::endl;
	...
	cout << "this took you " << duration.count() << std::endl;
